        ...
        return(
            <div>
                <div className='products-filter'>
                    <p>
                        {`${products.length} Product${this.props.data.length > 1 ? 's' : '' } found.`} {' '}
                    </p>
                    <OrderBy selectedOrder={selectedOrder} handleOrderBy/>
                </div>
...
function product(props){
    return(
        <div className='product-item'>
            ...
            <img className='product-item-img' src={`/static/products/${props.sku}_1.jpg`} alt={props.tittle} />
            <div className='product-item-details'>
                <p className='product-item-tittle'>{props.tittle}</p>
